...
import com.gara.sbcommon.utils.JSONUtils;
...
public class CustomerDocRepositoryTest extends EsDemoApplicationTests {
    ...
    @Test
    void testGetElasticSearchDocument() {
        Optional<CustomerDoc> customerDoc = customerDocRepository.findById(6L);
        System.out.println("JSONUtils.toJson(customerDoc) = " + JSONUtils.toJson(customerDoc));
    }
